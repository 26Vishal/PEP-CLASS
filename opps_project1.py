class BankAccount:
    ...
    def withdraw(self, amount):
        if amount <= self._balance:   # better condition
            self._balance -= amount
            return self._balance
        else:
...
print("Balace after deposite", app.deposit_money(2000))
print("Balance after withdrawl:",app.withdraw_money(2000))
